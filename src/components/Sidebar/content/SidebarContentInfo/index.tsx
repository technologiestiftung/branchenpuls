		...
		<>
			...
			<SidebarBody>
				<p className="text-sm text-dark-grey">
					Berlin ist Hauptstadt, Start-Up Metropole, Exzellenzcluster, Stadt der
					Künstler:innen, der Kreativen und immer im Wandel. Entsprechend
				...
				<Accordion
					...
					content={
						<p>
							...
							nach Informationen wie Branchen- und Gewerbetyp, Neueintragungen,
							Beschäftigtenzahl oder Unternehmensalter gefiltert werden.
							Außerdem ist eine räumliche Differenzierung auf Bezirksebene
							möglich. Durch die Zeitraumauswahl ist darüber hinaus eine
							zeitliche Entwicklung erkundbar, wie z.B. Neuansiedlungen, Umzüge
							oder Geschäftsaufgaben. Dazu können mehrere Ebenen geöffnet und
							...
							anderen Städten kostenlos genutzt, angepasst und weiterentwickelt
							werden. Wenn Du dich dafür interessierst, schau gerne im{" "}
							<a
								className="font-medium text-primary"
				...
				<Accordion
					...
					content={
						<p>
							...
							Berlin seit April 2023 als offene Daten veröffentlicht. Die Daten
							sind sowohl über das{" "}
							<a
								className="font-medium text-primary"
							...
							Mitgliedsunternehmen ab und aktualisiert die Daten monatlich. Bei
							Fragen zu den Daten wende dich gerne an den Bereich
				...
				<Accordion
					...
					content={
						<p>
							...
							aus Wirtschaft, Wissenschaft und Zivilgesellschaft profitieren von
							offenen Daten und veröffentlichen zunehmend selbst offene Daten.
							Die{" "}
							<a
								className="font-medium text-primary"
								href="https://odis-berlin.de/"
				...
				<p className="mt-[30px] text-xs font-medium text-light-grey">
					...
					<a className="font-medium text-primary" href="mailto:odis@ts.berlin">
						odis@ts.berlin
					</a>
					.
				</p>

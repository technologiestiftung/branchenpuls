...
import {BerlinLogo, CityLabLogo, IBBLogo, IHKLogo, OdisLogo, TSBLogo} from "@components/logos";

export const Welcome = ({ setShowWelcome }: { setShowWelcome: Dispatch<SetStateAction<boolean>>}) => {
  return <>
    <div className="absolute top-0 left-0">
      <div className="flex w-screen h-screen items-center justify-center py-[18px]">
        <div className="flex flex-col w-[320px] bg-white p-5 rounded">
          ...
          <h1 className="text-2xl font-bold mb-[16px] text-dark-grey">Wie schnell ist Berlins Branchenpuls?</h1>

          <p className="leading-4 font-extralight text-sm mb-[24px] text-dark-grey">
            Der BranchenPuls der IHK lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget
          ...
          <p className="italic font-extralight text-xs mb-[24px] text-dark-grey">
            Eine prototypische Datenvisualisierung der Open Data Informationsstelle Berlin in Zusammenarbeit mit dem
            CityLAB Berlin
          </p>

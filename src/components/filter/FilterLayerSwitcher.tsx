		...
		<div className="mt-2 flex">
			...
			{Object.keys(layersData).length < 3 ? (
				<button
					...
					className="grid h-12 w-1/3 cursor-pointer items-center rounded bg-gray-200 text-center font-bold leading-4 text-gray-400 hover:bg-light-grey hover:text-white"
